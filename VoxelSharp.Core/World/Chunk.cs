...
namespace VoxelSharp.Core.World
{
    public class Chunk
    {
        ...
        /// </summary>
        public Memory<Voxel> VoxelBuffer { get; }
        ...
        /// <summary>
        /// Provides a slice of the chunk's voxel data, useful for operations on a sub-region.
        /// </summary>
        ...
        /// <returns>A Memory slice of the requested sub-region.</returns>
        public Memory<Voxel> GetVoxelSlice(int xStart, int yStart, int zStart,
            int width, int height, int depth)
        {
            ...
            return VoxelBuffer.Slice(offset, length);
        }
    }
}